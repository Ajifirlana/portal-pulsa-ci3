                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                ...
                                <!--tabtour-->
                                <form method="post" action="<?php echo base_url('cari_kereta')?>">
                                <div class="tab-pane fade in" id="tabtour">
                                    <h3><br>Cari Kereta</br></h3>
                                    <ul class="list-inline list-unstyled">

                                        <li>
                                        <div class="form-group">
                                             
                                            <select name="asal" class="js-example-basic-single" style="width:100%;">
                                            <option value="SGU">Asal</option>
                                                <?php foreach ($stasiun as $s){?>
                                                <option value="<?= $s['id_stasiun']?>">
                                                <?= $s['nama_stasiun']?></option>
                                            <?php }?>
                                            </select>
                                                </div>
                                        </li>
                                        ...
                                        <li>
                                        <div class="form-group">
                                            <select name="tujuan" class="js-example-basic-single" style="width:100%;">
...
<?php foreach ($stasiun as $s){?>
                                        ...
                                        <li>
                                            <div class="form-group">
                                                <input type="date" name="tanggal_berangkat" class="form-control" placeholder="tanggal keberangkatan" required>
                                            </div>
                                        </li>
                            
                                        <li>
                                            <div class="form-group">
                                                <input type="text" readonly class="form-control" placeholder="Produk Kode" name="kode_produk" value="WKAI">
                                            </div>
                                        </li>
